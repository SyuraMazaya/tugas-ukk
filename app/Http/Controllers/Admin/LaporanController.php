...
class LaporanController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('admin.laporan.index', compact('peminjamanStats', 'pengembalianStats'));
    }
    ...
    public function peminjaman(Request $request): View
    {
        ...
        return view('admin.laporan.peminjaman', compact('peminjamans', 'status'));
    }
    ...
    public function pengembalian(Request $request): View
    {
        ...
        return view('admin.laporan.pengembalian', compact('pengembalians', 'status'));
    }
    ...
    public function printPeminjaman(Request $request): View
    {
        ...
        return view('admin.laporan.print-peminjaman', compact('peminjamans', 'status'));
    }
    ...
    public function printPengembalian(Request $request): View
    {
        ...
        return view('admin.laporan.print-pengembalian', compact('pengembalians', 'status'));
    }
}
