                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                <div class="inline-flex items-center gap-2">
                                    @if(in_array($pengembalian->status, ['menunggu_approval', 'menunggu_verifikasi_pembayaran']))
                                        <a href="{{ route('petugas.pengembalian.approval', $pengembalian->id) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 transition-colors">
                                            Approval
                                        </a>
                                    @endif
                                    <a href="{{ route('petugas.pengembalian.show', $pengembalian->id) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 transition-colors">
                                        Detail
                                    </a>
                                </div>
                            </td>
