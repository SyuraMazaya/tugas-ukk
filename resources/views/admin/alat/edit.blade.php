<x-layouts.app title="Edit Alat">
    ...
    <div class="mb-8">
        <nav class="flex items-center text-sm text-slate-500 mb-4">
            ...
            <span class="text-slate-700 font-medium">Edit Alat</span>
        </nav>
            ...
            <div class="mb-5">
                ...
                @if($alat->gambar)
                    <div class="mb-4 relative inline-block">
                        <img src="{{ asset('storage/' . $alat->gambar) }}" alt="{{ $alat->nama_alat }}" class="h-32 w-32 object-cover rounded-xl ring-1 ring-slate-200">
                        <span class="absolute -top-2 -right-2 bg-emerald-500 text-white text-xs px-2 py-0.5 rounded-full">Saat ini</span>
                    </div>
                @endif
